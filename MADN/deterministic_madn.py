...
def encode_board(env: deterministic_MADN) -> chex.Array:
    ...
    # ??????? ROLLED INDEX HANDLING ???????
    # WENN DAS BOARD ROTIERT WIRD SODASS e.g. DER AKTUELLE SPIELER IMMER AN POSITION 0 IST,
    # SOLL DANN AUCH DIE REIHENFOLGE BEI PLAYER CHANNELS ANGEPASSTE WERDEN SODASS ZUERST
    # SPIELER 1 POSITIONS IM ROTIERTEN FELD DANN DIE ANDERERN ODER BLEIBT ES BEI 0,1,2,3 ABER DANN MIT ROTIERTEM BOARD?
    #rolled idx
