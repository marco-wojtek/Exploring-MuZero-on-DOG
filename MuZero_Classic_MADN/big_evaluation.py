...
# ---------------------------------------------------------------------------
TRAINED_AGENTS = [
    # f"{FOLDER}stochastic_muzero_madn_params_lr0.005_g1500_it100_seed31.pkl",
    f"{FOLDER}stochastic_muzero_madn_params_lr0.005_g1500_it100_seed33.pkl",
    f"{FOLDER}stochastic_muzero_madn_params_lr0.005_g1500_it100_seed35.pkl",
    f"{FOLDER}stochastic_muzero_madn_params_lr0.005_g1500_it100_seed37.pkl",
]
...
def run_matchup(spec_a, spec_b, batch_size=BATCH_SIZE):
    ...
    return evaluate_agent_parallel(params_a, params_b, params_b, params_b,batch_size=batch_size)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Evaluating agents for FFA stochastic MADN...")
        run_big_evaluation()
