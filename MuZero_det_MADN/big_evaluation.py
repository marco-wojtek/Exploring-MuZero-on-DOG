...
from MuZero_det_MADN.evaluate_agent import evaluate_agent_parallel, fairness_check, play_n_randomly
...
# ---------------------------------------------------------------------------
TRAINED_AGENTS = [
    f"{FOLDER}gumbelmuzero_madn_params_lr0.005_g1500_it25_seed76.pkl",
    f"{FOLDER}gumbelmuzero_madn_params_lr0.005_g1500_it50_seed76.pkl",
    f"{FOLDER}gumbelmuzero_madn_params_lr0.005_g1500_it75_seed76.pkl",
    f"{FOLDER}gumbelmuzero_madn_params_lr0.005_g1500_it100_seed76.pkl",
]
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Evaluating agents for TEAM deterministic MADN...")
        run_big_evaluation()
    finally:
        wandb.finish()